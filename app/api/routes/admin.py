...
async def get_activation_codes(
    ...
    """
    return await service.get_codes(skip=skip, limit=limit, filters=filters)
...
async def get_all_users(
    ...
    """
    return await service.get_users(skip=skip, limit=limit, filter_obj=filters.model_dump())
...
async def get_all_events(
    ...
    """
    events = await service.get_events(filters=filters, skip=skip, limit=limit)
